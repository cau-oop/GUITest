...
#include "ui_agencymember.h"
#include "memberfail.h"
#include "memberfail2.h"
#include "login.h"
#include <io.h>

AgencyMember::AgencyMember(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AgencyMember)
{
    ui->setupUi(this);
}
...
void AgencyMember::on_pushButton_clicked() {
    QString id = ui->lineEdit->text();
    QString pwd = ui->lineEdit_2->text();
    QString name = ui->lineEdit_3->text();
    QString agencyName = ui->lineEdit_4->text();
    QString tele = ui->lineEdit_5->text();
    QString license = ui->lineEdit_6->text();
    ...
    success = AgencyMember::addUserInfo(ID, pwd.toStdString().c_str(), name.toStdString().c_str(), agencyName.toStdString().c_str(),
                tele.toStdString().c_str(), license.toStdString().c_str(), country.toStdString().c_str(), region.toStdString().c_str());
...
int AgencyMember::addUserInfo(char * input_ID, const char * input_PWD, const char * input_name, const char * input_agencyName, const char * input_phoneNumber,
            ...
            if(!strcmp(input_ID, "")||!strcmp(input_PWD,"")||!strcmp(input_name, "")||!strcmp(input_agencyName, "")||!strcmp(input_phoneNumber, "")||
